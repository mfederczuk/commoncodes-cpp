// <commoncodes/bits/args/options.hpp>
/*
...
#ifndef _COMMONCODES_BITS_ARGS_OPTIONS_HPP
#define _COMMONCODES_BITS_ARGS_OPTIONS_HPP

#include <commoncodes/bits/args/option_id.hpp>
#include <commoncodes/bits/args/option.hpp>

#define commoncodes_option(name, id_) \
		inline const ::commoncodes::option name = ::commoncodes::option::builder().id(::commoncodes::option_id(id_))

namespace commoncodes::options {
	#define __cc_opt_id_base "::commoncodes::options::"
	#define __cc_tmp(name) commoncodes_option(name, __cc_opt_id_base #name)
	...
	commoncodes_option(silent, __cc_silent_quiet_opt_id).alias('s', "silent");
	commoncodes_option(quiet,  __cc_silent_quiet_opt_id).alias('q', "quiet");
...
#endif /* _COMMONCODES_BITS_ARGS_OPTIONS_HPP */
